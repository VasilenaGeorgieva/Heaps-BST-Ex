...
public class BinarySearchTree<E extends Comparable<E>> {
    ...
    public boolean contains(E element) {
        ...
        while (current != null) {
            if (isEqual(element, current)) { break; }
    ...
    public List<E> range(E lower, E upper) {
      ...
      Deque<Node<E>> eDeque = new ArrayDeque<>();
      eDeque.offer(this.root);

      while (!eDeque.isEmpty()) {
          Node<E> current = eDeque.poll();

          if (current.getLeft() != null) {
              eDeque.offer(current.getLeft());
          }

          if (current.getRight() != null) {
              eDeque.offer(current.getRight());
          }
    ...
    public E floor(E element) {
        ...
        Node<E> current = this.root;//iterative form
